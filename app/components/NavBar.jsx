  ...
  return (
    <div className="flex items-center mt-2 mr-4 md:mt-0" ref={searchRef}>
      <form onSubmit={handleSearch} className="relative">
        ...
        {/* Floating search results - only rendered if showResults is true */}
          ...
          >
            ...
            <ul className="py-2">
              {searchResults.map((artwork) => {
                ...
                const artist = artwork?.Details?.Artist || "";
                const image = artwork?.card_img || "";
                const slug = artwork?.slug || "";
                const description = artwork?.Description || "";
                const essay = artwork?.Essay || "";

                return (
                  <li key={slug} className="hover:bg-gray-50">
                    <Link
                      href={`/artifacts/${slug}`}
                      ...
                      >
                        ...
                        <div className={isExpanded ? "flex-1" : ""}>
                          ...
                          <p
                            ...
                            dangerouslySetInnerHTML={{
                              __html: highlightMatch(artist, searchQuery),
                            }}
                          ></p>
